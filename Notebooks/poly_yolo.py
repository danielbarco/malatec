...
#/Users/nijeri/Documents/Malaria Project/Git/malatec/data/poly_yolo_simulator_dataset/yolo_classes.txt
#../data/poly_yolo_simulator_dataset/yolo_classes.txt

class YOLO(object):
    _defaults = {
        "model_path": '../data/weights/poly_yolo.h5',
        "anchors_path": '../data/poly_yolo_simulator_dataset/yolo_anchors.txt',
        "classes_path": '../data/poly_yolo_simulator_dataset/yolo_classes.txt',
        "score": 0.2,
        "iou": 0.4,
...
if __name__ == "__main__":
    ...
    def _main():
        ...
        annotation_path = '../data/poly_yolo_simulator_dataset/simulator-train.txt'
        validation_path = '../data/poly_yolo_simulator_dataset/simulator-val.txt'
        log_dir = '../data/weights'
        classes_path = '../data/poly_yolo_simulator_dataset/yolo_classes.txt'
        anchors_path = '../data/poly_yolo_simulator_dataset/yolo_anchors.txt'
